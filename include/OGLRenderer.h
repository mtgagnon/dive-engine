...
//    static float getCameraPositionY() {return camera_pos.z;}
...
private:
    ...
    static void renderActor(const Actor &actor, int x, int y, int z = 0); // actor and xyz pixels to render at. (default z=0 for 2d & 3d)
...
//    inline static std::vector<ImageDrawRequest> img_requests;
    ...
    inline static glm::vec3 camera_pos = {0, 0, 0};
